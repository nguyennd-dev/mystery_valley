...
public class SoundManager : MonoBehaviour
{
    ...
    [SerializeField] AudioClip _sfxPlaceBlock;
    [SerializeField] AudioClip _sfxTakeBlock;
    [SerializeField] AudioClip _sfxCountdownStep;
    [SerializeField] AudioClip _sfxCountdownEnd;
    ...
    public void PlaySfxCountdown(bool isEnd = false)
    {
        playSound(new AudioConfig()
        {
            Clip = isEnd ? _sfxCountdownEnd : _sfxCountdownStep,
            Type = AudioConfig.AudioType.SFX
        });
    }
